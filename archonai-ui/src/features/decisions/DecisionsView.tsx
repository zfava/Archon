  ...
  if (selected) {
    return (
      <div className="dec-detail">
        ...
        {/* Cross-system links */}
        <div className="dec-section">
          <div className="dec-section-label">Inspect &amp; Verify</div>
          <div className="dec-cross-links">
            <Link to={`/inspection`} className="dec-cross-link" onClick={() => {/* inspection will need the ID */}}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
              Inspect Rationale &amp; Policy
            </Link>
            <Link to="/proof-analytics" className="dec-cross-link">
              ...
              Proof Analytics Timeline
            </Link>
            <Link to="/simulation" className="dec-cross-link">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
              Simulate Similar Action
            </Link>
            <Link to="/action-safety" className="dec-cross-link">
