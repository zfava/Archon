  ...
  if (businessType === 'professional-services') {
    return (
      <div className="ob-hipaa-banner">
        ...
        <div className="ob-hipaa-banner-content">
          <strong>Client Trust Architecture:</strong>{' '}
          ArchonAI enforces strict client data segregation with multi-tenant isolation tested by
          automated security vectors. All billing actions require approval. Full audit trail supports
          SOC 2 compliance.
        </div>
      </div>
    );
